...
func build_nodes() -> void:
	...
	_build_overlay()
	_build_wind()
	apply_bytes(compute_bytes(model.T, model.P, model.ice, model.w_up, model.u, model.v))
...
func compute_bytes(t_arr: PackedFloat32Array, p_arr: PackedFloat32Array, ice_arr: PackedFloat32Array, w_arr: PackedFloat32Array,
